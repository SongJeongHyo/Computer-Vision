...
int main()
{
	...
	*/
	...
	for (int i = 0; i < H; i++) {
		for (int j = 0; j < W; j++) {
			if (Y[i * W + j] > 114 &&
					Cb[i * W + j] > 77 && Cb[i * W + j] < 127 &&
						Cr[i * W + j] < 173 && Cr[i * W + j] > 133) {
